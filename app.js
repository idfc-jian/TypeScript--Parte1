...
var preguntas = function (pregunta) {
...
var iniciarFormulario = function () { return __awaiter(void 0, void 0, void 0, function () {
    var nombre, edad, email, pais;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("=== Formulario Interactivo ===");
                return [4 /*yield*/, preguntas("¿Cuál es tu nombre?: ")];
            case 1:
                nombre = _a.sent();
                return [4 /*yield*/, preguntas("¿Cuál es tu edad?: ")];
            case 2:
                edad = _a.sent();
                return [4 /*yield*/, preguntas("¿Cuál es tu correo?: ")];
            case 3:
                email = _a.sent();
                return [4 /*yield*/, preguntas("¿En qué país vives?: ")];
            case 4:
                pais = _a.sent();
